...
[{block name="oedsgvobase_delete_shipping_address_modal"}]
    [{if $oxcmp_user}]
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        [{block name="oedsgvobase_delete_shipping_address_modal_contents"}]
                            <div class="row">
                                <div class="col-md-12">
                                    <form name="delete_shipping_address_modal_form_[{$shippingAddressId}]"
                                        ...
                                        <div class="hidden">
                                            ...
                                            <input type="hidden" name="fnc" value="oeDsgvoDeleteShippingAddress">
                    ...
                    <div class="modal-footer">
                        [{block name="oedsgvobase_delete_shipping_address_modal_footer"}]
