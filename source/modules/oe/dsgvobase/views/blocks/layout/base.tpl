...
[{if $oViewConf->getActiveClassName() == 'account' && $oView->oeDsgvoBaseIsUserDeleted()}]
    [{assign var="successMessage" value="OESDGVOBASE_SUCCESS_ACCOUNT_DELETED"|oxmultilangassign}]
    [{assign var="scriptToAddMessage" value='$("#loginAccount").after("<div id=\"oedsgvobase-user-account-delete-success\" class=\"status success corners alert alert-success\">'|cat:$successMessage|cat:'</div>");'}]
