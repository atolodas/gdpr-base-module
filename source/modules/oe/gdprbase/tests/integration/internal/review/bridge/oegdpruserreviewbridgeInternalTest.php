...
class oeGdprUserReviewBridgeInternalTest extends OxidTestCase
{
    ...
    {
        $this->setExpectedException('oeGdprReviewPermissionException');
    ...
    {
        return new oeGdprUserReviewBridge(
    ...
    {
        $userReviewServiceMock = $this->getMockBuilder('oeGdprUserReviewService')
