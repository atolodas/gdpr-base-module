...
class oeGdprUserReviewAndRatingServiceTest extends \PHPUnit_Framework_TestCase
{
    public function testReviewAndRatingListSorting()
    {
        $reviewAndRatingMergingServiceMock = $this
            ->getMockBuilder('oeGdprReviewAndRatingMergingService')
            ->getMock();
        ...
        $userReviewAndRatingService = new oeGdprUserReviewAndRatingService(
    ...
    private function getUserReviewServiceMock()
    {
        $userReviewService = $this
            ->getMockBuilder('oeGdprUserReviewService')
    ...
    private function getUserRatingServiceMock()
    {
        $userRatingService = $this
            ->getMockBuilder('oeGdprUserRatingService')
            ->disableOriginalConstructor()
            ->getMock();
