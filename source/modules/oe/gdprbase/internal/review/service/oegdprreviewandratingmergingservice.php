 ...
 * @internal
 */
class oeGdprReviewAndRatingMergingService
{
    /**
     * Merges oeGdprReviews and oeGdprRatings to array of oeGdprReviewAndRating view objects.
     *
     * @param array $reviews
     * @param array $ratings
     *
     ...
     *
     * @param oeGdprRating $rating
     * @param array        $reviews
     *
     * @return bool
     */
    private function isRatingWithoutReview(oeGdprRating $rating, array $reviews)
    {
        $withoutReview = true;
     ...
     *
     * @param oeGdprReview $review
     * @param oeGdprRating $rating
     *
     * @return bool
     */
    private function isReviewRating(oeGdprReview $review, oeGdprRating $rating)
    {
    ...
    /**
     * Maps Reviews and Ratings data to array of oeGdprReviewAndRating view objects.
     *
    ...
    /**
     * Maps Review and Rating data to oeGdprReviewAndRating view object.
     *
     * @param array $reviewAndRatingData
     *
     * @return oeGdprReviewAndRating
     */
