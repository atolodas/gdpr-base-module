 ...
 * @internal
 */
class oeGdprProductRatingService
{
    /**
     * @var oeGdprRatingDao
     */
    ...
    /**
     * oeGdprProductRatingService constructor.
     *
     * @param oeGdprRatingDao               $ratingDao
     * @param oeGdprProductRatingDao        $productRatingDao
     * @param oeGdprRatingCalculatorService $ratingCalculator
     */
    public function __construct(
        oeGdprRatingDao                  $ratingDao,
        oeGdprProductRatingDao           $productRatingDao,
        oeGdprRatingCalculatorService    $ratingCalculator
    ) {
