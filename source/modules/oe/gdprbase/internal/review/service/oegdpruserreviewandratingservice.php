 ...
 * @internal
 */
class oeGdprUserReviewAndRatingService
{
    /**
     ...
     * @param oeGdprReviewAndRatingMergingService $reviewAndRatingMergingService
     */
    public function __construct(
        oeGdprUserReviewService              $userReviewService,
        oeGdprUserRatingService              $userRatingService,
        oeGdprReviewAndRatingMergingService  $reviewAndRatingMergingService
    ) {
    ...
    /**
     * Sorts oeGdprReviewAndRating list.
     *
    ...
    {
        usort($reviewAndRatingListArray, function (oeGdprReviewAndRating $first, oeGdprReviewAndRating $second) {
