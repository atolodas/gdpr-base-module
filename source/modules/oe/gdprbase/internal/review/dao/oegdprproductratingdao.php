...
class oeGdprProductRatingDao
{
    ...
    /**
     * @param oeGdprProductRating $productRating
     */
    public function update(oeGdprProductRating $productRating)
    {
        $query = '
            UPDATE
                oxarticles
    ...
    {
        $productRating = new oeGdprProductRating();
        $productRating
     ...
     * @param string $productId
     *
     * @throws oeGdprInvalidObjectIdDaoException
     */
    private function validateProductId($productId)
    {
        if (empty($productId) || !is_string($productId)) {
            throw new oeGdprInvalidObjectIdDaoException();
        }
    }
}
